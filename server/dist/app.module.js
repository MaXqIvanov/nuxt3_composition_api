...
AppModule = __decorate([
    (0, common_1.Module)({
        imports: [category_module_1.CategoryModule, config_1.ConfigModule.forRoot(), serve_static_1.ServeStaticModule.forRoot({
            ...
            }), mongoose_1.MongooseModule.forRoot(`mongodb+srv://web_liter:${process.env.DATABASE_PASSWORD}@cluster0.mtot7.mongodb.net/internet_store?retryWrites=true&w=majority`)],
